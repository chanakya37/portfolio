    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <Button size="sm" className="glow-border border border-primary/30 hover:border-primary/60">Contact Me</Button>
        </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden glass-strong animate-fade-in">
          <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
            ...
            <Button onClick={() => setIsMobileMenuOpen(false)} className="glow-border border border-primary/30 hover:border-primary/60">
              Contact Me
            </Button>
          </div>
        </div>
